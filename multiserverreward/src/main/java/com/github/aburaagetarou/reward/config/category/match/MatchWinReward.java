 ...
 */
public class MatchWinReward extends MatchRewardBase {
    ...
    public static void loadAll() {
        ...
        // 通常報酬の読み込み
        MatchWinReward reward = new MatchWinReward();
    ...
    public String getKey() {
        return RewardTrigger.MATCH_WIN.getAlias();
    }
}
