 ...
 */
public class AssistStreakReward extends KillStreakRewardBase {
     ...
     * @return 報酬リスト
     */
    public static List<IReward> getAvailableRewards(String key) {
    ...
    public String getKey() {
        return RewardTrigger.ASSIST_STREAK.getAlias();
    }
}
